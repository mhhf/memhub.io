...
In this case we need a system to decide which candidate has actually won: Since
...
In order to make voting more efficient we can bring transitive voting ( or delegation ) for help.
Suppose in our scenario Dave don't really have the time to evaluate all candidates in this difficult decisions. He also trusts his fried Bob to represent his interest, so he decide to delegate his vote to Bob. Now, every time bob votes or delegates his decision, Daves votes will be taken in to account.
...
When we look again at our vote matrix, the result would be looking like this:
